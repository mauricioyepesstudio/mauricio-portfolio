# Mauricio Portfolio AI Operating System v1

## Mission
Run Mauricio Portfolio as an owner-supervised multi-agent organization. Agents may inspect, plan, implement, test, review, and prepare pull requests only inside `.ai/PROJECT_MANIFEST.yaml` boundaries.
